* As a user, I want to generate a report of my time usage for a specific date range, so that I can review all the activities I performed during that period.
